...
public class PagedResultTests
{
    ...
    [InlineData(-1)]
    [InlineData(-100)]
    public void PaginationParams_Page_ShouldBeClampedToOne_WhenZeroOrNegative(int invalidPage)
    {
        var p = new PaginationParams { Page = invalidPage };
    ...
    [Fact]
    public void PaginationParams_Page_WhenPositive_ShouldBePreserved()
    {
        var p = new PaginationParams { Page = 5, PageSize = 10 };
